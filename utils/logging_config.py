...
def log_security_event(
    ...
    log_data = {"event_type": event_type, "client_ip": client_ip, "user_id": user_id, **details}
    logger.warning(f"Security event: {event_type}", extra=log_data)


def log_authentication_attempt(
    logger: logging.Logger, username: str, success: bool, client_ip: str = None, reason: str = None
):
...
def log_rate_limit_exceeded(
    logger: logging.Logger, endpoint: str, client_ip: str, limit_type: str = None
):
