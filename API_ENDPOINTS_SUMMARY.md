...
## Overview
This implementation provides a complete REST API for SMTPy email aliasing service, based on ImprovMX-style API patterns. All endpoints are available under `/api/v1/` prefix.
